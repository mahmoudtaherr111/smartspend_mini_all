...
1. **في إعدادات بتتقري من البيئة مباشرة** من غير ما تعدي على الفحص، زي إعدادات التخزين ومفتاح تشفير مفاتيح
   الذكاء الاصطناعي.
2. **إشعار الدفع بيتسجل كامل في سجل السيرفر** قبل ما يتأكد منه.
3. **الأرقام القديمة بتضيع**: عدّاد الترقيات وتكلفة الذكاء الاصطناعي بتتمسح بعد شهر أو تلاتة، والملخص اللي
...
8. **في نسختين من إعداد المكالمات الصوتية** (واحدة في السيرفر الموحّد وواحدة في السيرفر المنفصل)، ولازم
