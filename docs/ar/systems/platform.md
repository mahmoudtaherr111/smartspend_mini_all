...
- **بيشغّل مهام يومية**: تنضيف الجلسات القديمة، التقارير الشهرية، مراجعة الاشتراكات، ومسح البيانات القديمة، ونقل
  العمليات المتسجلة بأسامي فئات قديمة للفئات الجديدة.
- **قايمة واحدة للفئات**: السيرفر والتطبيق بيقروا الفئات من نفس الملف، فمابقاش فيه نسختين ممكن يختلفوا.
