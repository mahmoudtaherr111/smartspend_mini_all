...
| سجلات التصنيف واستهلاك الذكاء الاصطناعي والإشعارات والصوت | 90 يوم |
| سجل العمليات المالية اللي الذكاء الاصطناعي نفّذها | سنة |
...
1. **دين تقني.** **في إعدادات بتتقري من البيئة مباشرة** من غير ما تعدي على الفحص، زي إعدادات التخزين ومفتاح تشفير مفاتيح
   الذكاء الاصطناعي.
2. **أمن.** **إشعار الدفع بيتسجل كامل في سجل السيرفر** قبل ما يتأكد منه.
3. **عطل.** **الأرقام القديمة بتضيع**: عدّاد الترقيات وتكلفة الذكاء الاصطناعي بتتمسح بعد شهر أو تلاتة، والملخص اللي
   بيتحفظ قبل المسح محدش بيقراه.
4. **دين تقني.** **صفحة غير موجودة** في وضع الإنتاج بتخلي السيرفر يقرا ملف من على الهارد مع كل طلب.
5. **دين تقني.** **عداد اتصالات التوثيق اللحظي** بيكبر في الذاكرة ومابيتنضفش غير لما السيرفر يعيد التشغيل.
6. **دين تقني.** **مراقبة الأخطاء (Sentry)** بتتسجل بأقصى تفصيل لكل طلب، وده مكلف في الإنتاج.
7. **دين تقني.** **سكربت «تعبئة بيانات أولية» فاضي** ومابيعملش حاجة.
8. **دين تقني.** **في نسختين من إعداد المكالمات الصوتية** (واحدة في السيرفر الموحّد وواحدة في السيرفر المنفصل)، ولازم
   الاتنين يتظبطوا مع بعض بإيد.
