...
4. **دين تقني.** **عداد اتصالات التوثيق اللحظي** بيكبر في الذاكرة ومابيتنضفش غير لما السيرفر يعيد التشغيل.
5. **دين تقني.** **مراقبة الأخطاء (Sentry)** بتتسجل بأقصى تفصيل لكل طلب، وده مكلف في الإنتاج.
6. **دين تقني.** **سكربت «تعبئة بيانات أولية» فاضي** ومابيعملش حاجة.
7. **دين تقني.** **في نسختين من إعداد المكالمات الصوتية** (واحدة في السيرفر الموحّد وواحدة في السيرفر المنفصل)، ولازم
