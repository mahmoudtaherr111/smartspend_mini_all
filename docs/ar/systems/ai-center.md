...
| تنفيذ بعد تأكيد | تسجيل مصروف (بيتصنّف بنفس محرك شاشة التسجيل)، تعديل تصنيف عملية (والتطبيق بيتعلم منه زي شاشة التعديل)، ميزانية، محفظة، تعديل أو إيقاف هدف، تراجع عن آخر إجراء |
