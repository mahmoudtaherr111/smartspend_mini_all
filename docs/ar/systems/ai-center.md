...
## النظام ده بيعمل إيه
مركز الذكاء الاصطناعي فيه تلات تبويبات: **الشات**، و**المكالمة الصوتية** (ليها صفحة لوحدها)، و**التحليل الشهري**
(ليه صفحة لوحده). الصفحة دي عن الشات. بتسأله «صرفت كام على الأكل الشهر ده؟» أو «ليه مصاريفي زادت؟» أو «اعملي هدف
...
- بعد كل رسالة المساعد بيحفظ ملخص قصير للمحادثة، ويلقط من كلامك الحاجات المهمة: اللي بتحبه ومابتحبوش، والشروط اللي
  ...
  عليها.
- لما تسأله عن حاجة قديمة، بيدور في الملخصات والحاجات المحفوظة والإجراءات اللي اتنفذت.
- تقدر تشوف كل اللي فاكره عنك، وتمسح حاجة معينة أو تمسح كله، من شاشة الذاكرة جوه الشات.
...
- «خلّي تراجع يلغي المصروف اللي المساعد سجله»: ده إصلاح المشكلة السادسة.
