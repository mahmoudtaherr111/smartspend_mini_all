...
4. **عطل.** **قايمة المميزات في صفحة الخطط مش مطابقة للتطبيق**: مثلاً مكتوب 10 طلبات في اليوم للمجاني والشات بيسمح بـ20، وتصدير
   Excel مالوش زرار.
5. **أمن.** **خارج الإنتاج، ولو سر Paymob مش متظبط**، السيرفر بيقبل إشعار دفع مش موقّع ويفعّل الباقة منه.
6. **دين تقني.** **مفيش اختبارات** بتتأكد إن التحقق من إشعار الدفع وتفعيل الباقة شغالين صح.

## لو عايز تطلب تعديل
تكلفة مزوّد الصوت ممكن تتراجع من [معمل اختبار الصوت](../../guides/voice-quality-lab.md). أسعار جوجل المؤرخة
هناك مدخلات للقياس، مش أسعار باقات. لو بيانات التوكنز ناقصة أو حسابها مش واضح، التقرير مابيطلعش تكلفة إجمالية
مؤكدة وماينفعش نبني عليها رصيد الدقايق.
