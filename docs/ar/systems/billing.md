...
- **كل باقة فيها إيه**: الأدمن هو اللي بيحدده من لوحة التحكم، مش الكود. فيه تبويب لكل باقة (المجانية وPro وUltra) فيه
  الحدود (التسجيلات في اليوم، ورصيد الذكاء الاصطناعي، والصوت، ورسايل البنك، والأهداف، والشات...) ومفاتيح تشغيل المميزات
  (وضع البيزنس، والإيصالات، وتقرير Pro للطباعة، وتحليل الأهداف، وتقرير الواتساب). القيم المبدئية هي نفس اللي كانت مكتوبة
  في الكود قبل كده. وصفحة الخطط بتعرض نفس الأرقام دي، فمش ممكن توعد بحاجة غير اللي السيرفر بيطبقه.
...
- **بيانات الكارت مابتتكتبش في سجل السيرفر**: من إشعار Paymob بيتكتب رقم العملية، ونجحت ولا لأ، والمبلغ بس.
...
1. **ناقص.** **مفيش طريقة تشتري Ultra**: زرار الترقية بيوديك لصفحة فيها «هنضيف مميزات قريباً»، وأي حد داخل يقدر يفتحها. والاشتراك
   السنوي مالوش زرار.
2. **ناقص.** **كود الدعوة لسه مابيديش خصم**: الدفع دايماً بالسعر الكامل، واللي دعاك مابياخدش حاجة، فالشاشة مابقتش بتوعد بخصم
   لحد ما الخصم يتطبق فعلاً في الدفع. وأكواد الخصم اللي الأدمن بيعملها مابتتطبقش.
3. **ناقص.** **مفيش تجديد تلقائي**: التطبيق بيفكّرك قبل ما الاشتراك يخلص بـ3 أيام وتاني آخر يوم، وإنت بتدفع تاني. و«إلغاء البرو»
   بيغير الحالة المكتوبة بس، ومفيش استرجاع فلوس من التطبيق.
4. **أمن.** **خارج الإنتاج، ولو سر Paymob مش متظبط**، السيرفر بيقبل إشعار دفع مش موقّع ويفعّل الباقة منه.
5. **دين تقني.** **مفيش اختبارات** بتتأكد إن التحقق من إشعار الدفع وتفعيل الباقة شغالين صح.
