...
1. **مفيش طريقة تشتري Ultra**: زرار الترقية بيوديك لصفحة فيها «هنضيف مميزات قريباً»، وأي حد داخل يقدر يفتحها. والاشتراك
   السنوي مالوش زرار.
2. **خصم كود الدعوة بيتكتب بس**: الدفع دايماً بالسعر الكامل، واللي دعاك مابياخدش حاجة، وأكواد الخصم اللي الأدمن بيعملها
   مابتتطبقش.
3. **مفيش تجديد تلقائي**، و«إلغاء البرو» بيغير الحالة المكتوبة بس، ومفيش استرجاع فلوس من التطبيق.
4. **قايمة المميزات في صفحة الخطط مش مطابقة للتطبيق**: مثلاً مكتوب 10 طلبات في اليوم للمجاني والشات بيسمح بـ20، وتصدير
   Excel مالوش زرار.
