...
1. **ناقص.** **تطبيق الأندرويد نسخة تجريبية (debug)**: بيتبني لوحده لما كوده يتغير، بس النسخة الجديدة مش هتتركّب فوق
   القديمة لحد ما يتحط مفتاح توقيع ثابت.
2. **ناقص.** **قراءة الموديل للرسايل مابتتحسبش في حدود الذكاء الاصطناعي** ولا تكاليفه، ومابتستخدمش المزودين اللي الأدمن
   اختارهم.
3. **ناقص.** **التصنيف لسه بخريطة ثابتة** إلا لمحل التطبيق عارفه كويس (الدفع فيه، والمرتجع منه اللي بيرجع لنفس الفئة): الدفع بالكارت في محل مش معروف بيبقى «تسوق»، والتحويل
   لحد بيتسجل مصروف تحت «تحويل».
4. **ناقص.** **الرسايل الأصلية بتتحفظ بنصها** (فيها أرقام الحساب والرصيد) لمدة 90 يوم، وبعدها بتتمسح، حتى الاقتراح اللي ماتأكدش.
