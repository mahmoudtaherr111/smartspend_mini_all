...
- **مجاميع كل يوم**: مع كل عملية بتتسجل أو تتمسح، مجموع اليوم بيتحدث في نفس اللحظة، وكل ليلة التطبيق بيراجع آخر
  شهرين ويصلح أي فرق.
- **الصفحة الرئيسية**: فيها تلات تبويبات: تسجيل، وإحصائيات، وتقويم.
...
- **تبويب التسجيل**: خانة التسجيل، وآخر عملياتك في الشهر مع إمكانية المسح، وكارت إنشاء هدف.
...
- **الأهداف**: هدف باسم ومبلغ وتاريخ. الباقة المجانية لحد 3 أهداف نشطة. مشتركين Pro يقدروا يطلبوا «تحليل Pro»
  يعمل خطة ادخار. تقدر تخلي الهدف نشط أو متوقف أو مكتمل، أو تمسحه.

## وضع المشروع والأشخاص
- **وضع المشروع** (لمشتركين Pro): مشروع واحد نشط ليه فئاته. الذكاء الاصطناعي يقدر يقترح الفئات من وصف مشروعك،
...
2. **يوم المرتب اللي بتقوله في أسئلة التعريف** مابيغيرش حساب الصفحة الرئيسية؛ لازم تفعّل «مرتب ثابت» من الإعدادات.
...
4. **تبويب الميزانية والمدفوعات الإلكترونية وخريطة التوقيت** بيحسبوا من آخر 200 عملية بس في الشهر، ولو مفيش دخل
