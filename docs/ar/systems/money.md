...
- **تبويب التسجيل**: خانة التسجيل، ورسايل البنك المستنية تأكيدك لو فيه (اللي وصلت بعد حد الباقة)، وآخر عملياتك في
  الشهر مع إمكانية المسح (لون كل فئة ثابت من قايمة الفئات)، وكارت
  إنشاء هدف.
...
10. **ناقص.** **المرتجع بيتسجل دخل** («دخل آخر/مرتجعات»)، ومابيقللش مصروف الفئة اللي الحاجة اتشرت منها. ده مستني تعريف
