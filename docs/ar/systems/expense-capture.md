...
- بعد ما ترد، التطبيق يعيد فهم الجملة ومعاها ردك، ويسجّل. ولو رديت مرتين، بتتسجل مرة واحدة بس.
...
1. **عطل.** العمليات اللي بتتسجل بعد سؤال مابتحدّثش «الذاكرة» ولا عداد الأيام المتتالية زي التسجيل العادي.
2. **عطل.** الإيصال بيتسجل من غير مراجعة، والمبلغ اللي بيتسجل ممكن يبقى أول رقم في الإيصال مش الإجمالي.
3. **عطل.** خدمتين الصوت بيعدّوا الشهر بطريقتين مختلفتين، والتسجيل الصوتي بيضيف الأشخاص لقايمتك حتى لو ماحفظتش.
4. **عطل.** في حالة نادرة لما التطبيق مايبقاش واثق في أي جزء من جملة فيها كذا مبلغ، ممكن يسجل أول مبلغ ويسألك عن الباقي.
