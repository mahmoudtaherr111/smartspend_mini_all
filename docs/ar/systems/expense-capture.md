...
مرتب أو قبضت أو «من الشغل». العيدية اللي خدتها «هدايا وعيديات»، والفلوس اللي رجعتلك من حاجة رجّعتها «مرتجعات»، وتمن
...
- **التعديل:** لما تعدّل فئة عملية متسجلة، التطبيق بيفتكر اختيارك للجمل اللي شبهها. التعديل في بطاقات المراجعة قبل
  الحفظ لسه مابيتسجلش.
