...
3. **عطل.** **الإعدادات الافتراضية** اللي الكود بيستخدمها لما الأدمن مايحددش (زي عدد الدقايق المجانية) مختلفة عن اللي مكتوبة في
   قايمة الإعدادات.
4. **عطل.** **الدقايق الشهرية بتتحسب** مع ثواني تسجيل المصاريف بالصوت كأنهم رصيد واحد، وبتوقيت السيرفر مش القاهرة.
5. **عطل.** **لو السيرفر وقع في نص مكالمة**، مدتها مابتتحسبش.
