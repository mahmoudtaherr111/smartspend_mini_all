...
4. **دين تقني.** **قايمة الصفحات اللي فيها شريط التنقل مكتوبة مرتين**، فلو حد ضاف صفحة جديدة ونسي القايمة التانية، الشريط
   هيختفي منها.
5. **ناقص.** **لو عملت تسجيل خروج** والحاجات اللي سجلتها وإنت أوفلاين لسه مارفعتش، بتتمسح من الجهاز. شاشة «المزيد» بتحذّرك
   وبتقولك عددها قبل ما تخرج، بس الخروج من القايمة الجانبية مابيحذّرش.
