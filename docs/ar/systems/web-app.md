...
4. **قايمة الصفحات اللي فيها شريط التنقل مكتوبة مرتين**، فلو حد ضاف صفحة جديدة ونسي القايمة التانية، الشريط
   هيختفي منها.
5. **لو عملت تسجيل خروج** والحاجات اللي سجلتها وإنت أوفلاين لسه مارفعتش، بتضيع.
6. **التطبيق بيبعت حاجة واحدة بس عن الاستخدام** (مدة الجلسة)، فالأرقام في لوحة التحكم مابتوصفش استخدام الناس
   فعلاً.
