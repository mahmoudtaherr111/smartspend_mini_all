...
- **يختار** مين يرد على الطلب ده حسب نوع الشغل (تصنيف، شات، تقرير، صوت) وباقة المستخدم. في التصنيف، الاختيار من
  الموديلات اللي الأدمن حددها في «المزودات والموديلات»، ولو مفيش، موديل Gemini بتاع الباقة؛ مابقاش بيتغير على حسب
  المستخدم صرف كام توكن.
...
- **موديلات Gemini اللي بنستخدمها موجودة فعلاً**: Gemini 3.8 Flash (الأقوى، وافتراضي باقة Ultra)، وGemini 3.5 Flash Lite،
  وGemini 3.1 Flash Lite (الأخف، وافتراضي باقي الباقات). اسم «gemini-3.1-pro» جوجل مابيقدموش أصلاً، فأي مكان لسه كاتبه
  بيتحول لـ3.8 Flash. ولو جوجل قال إن الموديل زحمة أو إن حصته خلصت، أو الموديل اتأخر عن الوقت اللي الطلب يستحمله، الطلب بيروح للموديل اللي بعده (الأخف الأول، وبعدين الأقوى) بدل ما
  يفشل.

## التكلفة بتتحسب إزاي
- كل مرة التطبيق بيكلم موديل لمستخدم، بيتكتب سطر في سجل التكلفة: المزود والموديل والتوكنز الداخلة والطالعة وتفكير الموديل،
  والتكلفة بالدولار وبالجنيه بسعر الدولار اللي الأدمن بيحطه في الإعدادات.
- السعر بييجي من السعر اللي الأدمن حاطه للموديل في لوحة المزودين، ولو مفيش، من السعر اللي المزود نفسه ناشره لموديلات
  جوجل اللي التطبيق بيستخدمها. الموديل اللي مالوش سعر خالص بيتسجل «من غير سعر» ومابيتخمنش.
- ده بيغطي تصنيف المصاريف (كل محاولة لوحدها بسعر مزودها، حتى اللي فشلت)، والشات، والمكالمة الصوتية وأدواتها، والتقارير،
  والإيصالات، والأهداف، ورسايل البنك. فلو غيرت المزود بكرة، الحساب بيفضل مظبوط.
...
- **حد السرعة**: لو حد بعت طلبات كتير في دقيقة واحدة، بيتقاله استنى شوية. والعدد ده الأدمن بيغيّره لكل باقة من اللوحة. العدد لكل باقة بيحدده الأدمن (20 و60 و100 في الأول).
...
1. **ناقص.** **فيه حسابين للتكلفة لسه**: سجل التكلفة الرئيسي (اللي بيتحسب بالسعر الحقيقي) وسجل تاني قديم بيقدّر التوكنز
   لوحده، وشاشته مش ظاهرة في اللوحة.
2. **ناقص.** **تحويل الصوت لنص** بيتحسب بسعر الكلام المكتوب مع إن اللي داخل صوت، والموديل اللي الأدمن يضيفه من غير سعر
   بيتسجل «من غير سعر» لحد ما يتحط له سعر.
3. **دين تقني.** **في قايمة موديلات مكتوبة بإيد** جوه الكود ومحدش بيقراها، وأسماء الموديلات الافتراضية مكررة في أكتر من مكان.
4. **دين تقني.** **كل سيرفر بيتعلم لوحده**: لو عندك أكتر من سيرفر، كل واحد بيكتشف الشركة الواقعة لوحده، وتغيير الإعدادات
   بيوصلهم في أوقات مختلفة.
5. **عطل.** **بداية الشهر في حساب الحدود** بتوقيت السيرفر مش القاهرة.
