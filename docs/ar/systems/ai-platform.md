...
1. **مفاتيح الشركات متشفّرة بمفتاح النظام**: لو غيّرت `JWT_SECRET` من غير ما تحط `AI_GATEWAY_SECRET`، كل
...
3. **التكلفة المعروضة في اللوحة تقديرية**: بتتحسب بسعر ثابت مكتوب في الكود، مش بسعر الموديل الحقيقي ولا بسعر
   الدولار اللي في الإعدادات.
4. **مش كل الاستهلاك بيوصل لنفس المكان**: شات الذكاء الاصطناعي والمكالمات الصوتية بتتسجل في مكان تاني غير
...
6. **الطريقة القديمة لسه شغالة**: أغلب الطلبات بتختار الشركة من الإعدادات القديمة مش من الشركات اللي الأدمن
   ضايفها في اللوحة، ومستخدم الألترا بيتعامل بإعدادات الـPro.
7. **كل سيرفر بيتعلم لوحده**: لو عندك أكتر من سيرفر، كل واحد بيكتشف الشركة الواقعة لوحده، وتغيير الإعدادات
