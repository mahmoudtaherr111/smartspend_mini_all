...
| الذكاء الاصطناعي | أخطاء المفاتيح، وتكلفة الاستهلاك في الشهر الحالي، والمزودين وموديلاتهم وأسعارهم، واستهلاك مستخدم معين مقارنةً بالحد الحقيقي بتاعه، ومعمل تجربة التصنيف |
...
| الحدود والإعدادات | تبويب لكل باقة (المجانية وPro وUltra) فيه كل حدودها ومفاتيح تشغيل مميزاتها (منها عدد رسايل البنك اللي بتتسجل لوحدها في الشهر، واللي بعدها بتستنى المستخدم يأكدها)، وحدود الشات والمكالمة لكل باقة، ومفاتيح الخدمات مع اختبارها، وأكواد الخصم |
...
3. **دين تقني.** **قسم الذكاء الاصطناعي بيطلب بيانات ومابيعرضهاش**: أرقام التصنيف والصوت والتكلفة التفصيلية بتتحمّل وماحدش
