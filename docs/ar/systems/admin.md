...
| الذكاء الاصطناعي | أخطاء المفاتيح، وتكلفة الاستهلاك في الشهر الحالي، والمزودين وموديلاتهم وأسعارهم، واستهلاك مستخدم معين، ومعمل تجربة التصنيف |
...
| الحدود والإعدادات | حدود كل باقة، ومفاتيح الخدمات مع اختبارها، وأكواد الخصم |

## ليه كده؟
- **المفاتيح السرية مابتظهرش**: بتتعرض بآخر 4 حروف بس، ولو حفظت أي إعداد تاني المفتاح مابيتمسحش.
- **تغيير الدور أو الباقة بيبان فوراً**: الجلسات المحفوظة بتتحدث في نفس اللحظة.
...
1. **أمن.** **إلغاء جلسة** مابيقفلهاش فوراً؛ ممكن تفضل شغالة لحد ربع ساعة.
2. **ناقص.** **مفيش سجل بأفعال الأدمن**: مين غيّر دور أو باقة أو إعداد أو مسح حساب مش متسجل في أي مكان، و«سجل الرقابة»
   مجرد قايمة جلسات.
3. **دين تقني.** **تغيير الإعدادات** ممكن ياخد لحد 5 دقايق عشان يوصل لكل السيرفرات.
4. **عطل.** **شاشة استهلاك المستخدم** بتقارن بحدود ثابتة مكتوبة في الكود، مش بالحدود اللي إنت كاتبها في الإعدادات.
5. **دين تقني.** **قسم الذكاء الاصطناعي بيطلب بيانات ومابيعرضهاش**: أرقام التصنيف والصوت والتكلفة التفصيلية بتتحمّل وماحدش
   بيشوفها، والشاشة اللي كانت هتعرضها موجودة في الكود بس مش متوصلة.
6. **ناقص.** **زرار «النسخة الاحتياطية»** بينزل الإعدادات وشوية بيانات بس، مش نسخة من قاعدة البيانات.
7. **ناقص.** **لما الأدمن يرد على تذكرة** المستخدم مابيوصلوش إشعار، مع إن صفحة الدعم بتوعد برد خلال يوم.
8. **ناقص.** **بيانات محركات البحث**: خريطة الموقع مش متاحة لأي محرك بحث أصلاً، ومفيش شاشة لتعديل عناوين الصفحات.
9. **عطل.** **عداد مشاهدات الإعلانات مافيش حاجة بتزوّده**، فنسبة النقر في القسم بتفضل صفر.
10. **ناقص.** **في عمليات موجودة في السيرفر من غير شاشة**، زي إرسال إشعار يدوي، أو تحديد حد استهلاك لمستخدم معين، أو
    تعيين تذكرة لمشرف.
11. **عطل.** **أكواد الخصم بتتعمل من اللوحة** بس مابتتطبقش في الدفع، وقسم الواتساب دايماً بيقول إن التوثيق مقفول.
12. **عطل.** **أرقام المستخدمين النشطين** محسوبة بتوقيت السيرفر مش القاهرة، و«ترقيات Pro» مابتحسبش الترقية لـUltra.
