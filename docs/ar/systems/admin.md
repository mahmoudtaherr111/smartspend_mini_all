...
2. **مفيش سجل بأفعال الأدمن**: مين غيّر دور أو باقة أو إعداد أو مسح حساب مش متسجل في أي مكان، و«سجل الرقابة»
   مجرد قايمة جلسات.
...
5. **قسم الذكاء الاصطناعي بيطلب بيانات ومابيعرضهاش**: أرقام التصنيف والصوت والتكلفة التفصيلية بتتحمّل وماحدش
...
10. **في عمليات موجودة في السيرفر من غير شاشة**، زي إرسال إشعار يدوي، أو تحديد حد استهلاك لمستخدم معين، أو
    تعيين تذكرة لمشرف.
