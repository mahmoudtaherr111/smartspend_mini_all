...
1. **عطل.** **التسجيل برقم التليفون مع توثيق الواتساب مابيكملش**: الكود اللي المفروض تبعته مش بيظهر لك، و«تخطي الآن» بيرفض.
2. **أمن.** **لما توثيق الواتساب مقفول**، أي حد يقدر يسجل بأي رقم من غير ما يثبت إنه بتاعه.
3. **أمن.** **على السيرفر الحقيقي طلب كود التوثيق بيترفض**، لأن التطبيق مش بيبعت اختبار «أنا مش روبوت»، وفي نفس الوقت الاختبار
   ده ممكن يتعدى بكود تجريبي معروف.
4. **أمن.** **في طريقة دخول بالكود من غير كلمة سر مش مستخدمة**؛ لو حد صلّح التسجيل بإنه يعرض الكود في التطبيق من غير ما يقفلها،
   أي حد هيقدر يدخل على حساب غيره.
5. **عطل.** **تغيير الاسم أو الصورة من الإعدادات مابيتحفظش**، ومن غير رسالة خطأ، وتغيير رقم التليفون مالوش شاشة.
6. **ناقص.** **مفيش طريقة تمسح بصمة سجلتها**، ولا تشوف الأجهزة الداخلة على حسابك وتخرجها، ولا تمسح حسابك بنفسك (الأدمن بس).
7. **أمن.** **رقم قفل التطبيق** محفوظ على الموبايل بحماية بسيطة؛ هو قفل للراحة مش حماية قوية.
8. **أمن.** **سجلات السيرفر فيها أكواد التوثيق وأرقام الموبايلات** اللي بعتت للبوت.
