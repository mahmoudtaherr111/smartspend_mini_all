...
4. **أمن.** **مشتركين Ultra مابيوصلهمش تقرير الواتساب**، ومفتاح «إرسال التقرير عبر الواتساب» في الإعدادات مابيوقفوش، ورقم
...
7. **عطل.** **ملف تقرير Pro مكتوب عليه «SpinSmart»** بدل SmartSpend.
8. **عطل.** **التقرير الأساسي ممكن يقول إن التوكنز خلصت** حتى لو السبب الحقيقي إن مفتاح الموديل مش متظبط.
9. **عطل.** **وصف «سلوك الصرف» في ملفك** بيكبر مع كل إجابة أو تعديل لحد تحديث أول الشهر، وبيتبعت للتصنيف كده.
