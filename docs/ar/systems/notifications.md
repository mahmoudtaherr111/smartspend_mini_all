...
1. **دين تقني.** **مفيش اختبارات** بتتأكد إن الإشعارات أو الواتساب شغالين صح.
2. **عطل.** **لوحة الأدمن دايماً بتقول إن توثيق الواتساب مقفول**، حتى لو الإعداد الحقيقي مفتوح.
3. **عطل.** **رسالة طلب الإذن بتوعد بحاجات مش موجودة**: متابعة أسبوعية، وتذكير يومي بالصوت، وتنبيه لميزانية كل فئة.
...
7. **أمن.** **سجلات السيرفر فيها أكواد التوثيق وأرقام الموبايلات**.
8. **دين تقني.** **ربط الواتساب محفوظ على سيرفر واحد**، ولو السيرفر اتغير الربط بيضيع.
9. **ناقص.** **مفيش طريقة تقفل الإشعارات من التطبيق**، ولا تمسح الجرس أو تعلّم الكل كمقروء.
10. **عطل.** **الإشعارات التلقائية بتتبعت الساعة 8 بتوقيت السيرفر** مش القاهرة.
