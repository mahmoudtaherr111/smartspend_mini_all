...
- The chart's "budget" tab compares spending with income rather than with the user's budgets, and assumes a 10,000 EGP budget when neither the profile nor the month has income.
