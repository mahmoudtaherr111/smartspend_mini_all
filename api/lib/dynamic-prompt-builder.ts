...
You must output a JSON object containing ONLY the \`items\` array. DO NOT output \`thoughts\` or \`decomposed_sentences\`.`
    : `JSON Schema Instruction:
You must output a JSON object containing a \`thoughts\` array before the \`items\` array to enable Chain-of-Thought (CoT).`;
...
6. confidence: درجة الثقة في التصنيف كنسبة مئوية بين 0 و 100 (مثال: 95).${knownPeopleBlock}${multiTransactionRules}${ragContext}
