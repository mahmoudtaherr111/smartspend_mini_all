...
const KEYWORD_PRIORS: Array<{ pattern: RegExp; categories: string[] }> = [
  ...
  {
    pattern:
      /قهو|نسكاف|كافيه|لاتيه|كابتشينو|ستاربكس|اكل|غدا|فطار|عشا|مطعم|كشري|شاورما|بيتزا|برجر/i,
    categories: ["أكل وشرب"],
  },
  {
    pattern:
      /سوبر|بقال|كارفور|سبينيس|كازيون|خير\s*زمان|خضار|فاكهه|عيش|لبن|بيض|فرن|مخبز/i,
    categories: ["أكل وشرب"],
  },
  ...
  {
    pattern:
      /اوبر|كريم|اندرايف|ديدي|تاكسي|ميكروباص|مترو|اتوبيس|بنزين|تفويل|مواصلات|توكتوك|تكتوك/i,
    categories: ["مواصلات", "خدمات سيارات"],
  },

  // Bills / Utilities (exact-ish signals)
  {
    pattern:
      /فاتور|عداد|كهرب|ميه|مياه|غاز|ضرايب|تامين|قسط|اقساط|مديونيه|فيزا|ماستر/i,
    categories: ["فواتير"],
  },
  // Internet/Telecom with word-boundary style guards to avoid matching "انت/كنت"
  {
    pattern:
      /(?:^|\s)(?:نت|النت|انترنت|الانترنت|راوتر|واي\s*فاي|wifi|dsl|adsl|we|tedata)(?=\s|$|[.,،؟?!؛:])/i,
    categories: ["فواتير"],
  },
  {
  ...
  {
    pattern:
      /ايجار|اجار|شقه|شقة|بيت|سكن|نظاف|منظف|بويا|نقاش|سباك|نجار|كهربائي|صيانه\s*(?:بيت|شقه)?/i,
    categories: ["سكن"],
  },
  
  // Personal Care
  {
    pattern: /حلاق|كوافير|مغسلة|مغسله|دراي\s*كلين|عناية|شعر|جيم/i,
    categories: ["تسوق"],
  },
  ...
  {
    pattern:
      /صيدل|دوا|دواء|دكتور|كشف|عياده|تحاليل|معمل|مختبر|مستشفى|اسنان|نظاره/i,
    categories: ["صحة"],
  },

  // Education
  {
    pattern: /مدرسه|جامعه|كورس|كورسات|درس|دروس|سنتر|مذكره|ملزمه|كتاب|كتب/i,
    categories: ["تعليم"],
  },
  ...
  {
    pattern:
      /نتفلكس|سبوتيفاي|شاهد|watch\s*it|واتش\s*ات|يوتيوب\s*بريميوم|اشتراك/i,
    categories: ["اشتراكات", "ترفيه"],
  },
  {
    pattern:
  ...
  // Smoking
  {
    pattern: /سجاير|سجائر|فيب|ليكود|شيشه|شيشة|معسل|تدخين/i,
    categories: ["تدخين"],
  },
  ...
  {
    pattern:
      /مرتب|راتب|قبضت|قبض|استلمت|جالي|وصلني|معاش|بونص|مكاف|اوفرتايم|بدل|عموله|سبوبه|فريلانس|كاش\s*باك|استرجاع/i,
    categories: ["مرتب", "عمل حر", "عوائد استثمار"],
  },
];
