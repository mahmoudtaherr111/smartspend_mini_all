...
const KEYWORD_PRIORS: Array<{ pattern: RegExp; categories: string[] }> = [
  ...
  {
    pattern:
      /سوبر|بقال|كارفور|سبينيس|كازيون|خير\s*زمان|خضار|فاكهه|عيش|لبن|بيض/i,
    categories: ["أكل وشرب"],
  },
  ...
  {
    pattern:
      /اوبر|كريم|اندرايف|ديدي|تاكسي|ميكروباص|مترو|اتوبيس|بنزين|تفويل|مواصلات/i,
  ...
  {
    pattern:
      /ايجار|اجار|شقه|شقة|بيت|سكن|نظاف|منظف|بويا|نقاش|سباك|نجار|صيانه\s*(?:بيت|شقه)?/i,
    categories: ["سكن"],
  },
