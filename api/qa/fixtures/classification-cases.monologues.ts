...
export const MONOLOGUE_CASES: BenchmarkCase[] = [
  {
    ...
    expectedItems: [
      ...
      },
      {
        ...
        category: "تحويل",
        subCategory: "جمعية",
        why: "قبضت الجمعية = تحويل وارد (ادخار، مش دخل) — ركيزة الاتجاه",
      },
...

  {
    ...
    expectedItems: [
      ...
      { amount: 150, type: "expense", category: "سكن", subCategory: "منظفات" },
      {
        ...
        why: "استلفت = تحويل وارد (سلفة)",
      },
      { amount: 300, type: "transfer", category: "تحويل", subCategory: "دين/سلفة", why: "سلفت سيف = تحويل صادر (سلفة)" },
      {
        amount: 150,
        type: "transfer",
        category: "تحويل",
        subCategory: "دين/سلفة",
        why: "رجعلي = سلفة راجعة، تحويل وارد",
      },
...

  {
    ...
    expectedItems: [
      ...
      { amount: 4000, type: "expense", category: "تعليم", subCategory: "كورسات" },
      {
        ...
        categoryAnyOf: ["عوائد استثمار", "استثمار", "متنوعات", "دخل آخر"],
        subCategoryMode: "soft",
        why: "أرنب = مليون",
      },
    ],
