...
describe("lifestyle inference engine", () => {
  it("builds monthly behavior snapshot and detects spikes", () => {
    ...
    const snapshot = buildBehaviorSnapshot([
      { amount: 10000, type: "income", category: "salary", date: "2026-05-01" },
      { amount: 200, type: "expense", category: "food", subCategory: "coffee", date: "2026-05-02" },
      { amount: 200, type: "expense", category: "transport", subCategory: "metro", date: "2026-05-04" },
      { amount: 3000, type: "expense", category: "shopping", subCategory: "electronics", date: "2026-05-03" },
    ], [], profile);
